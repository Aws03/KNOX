        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Users_WriterId",
                        column: x => x.WriterId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserReactions_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CourseRequirementMappings",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    RequirementNature = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseRequirementMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseRequirementMappings_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseRequirementMappings_Majors_MajorId",
                        column: x => x.MajorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseRequirementMappings_CourseId",
                table: "CourseRequirementMappings",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseRequirementMappings_MajorId",
                table: "CourseRequirementMappings",
                column: "MajorId");
